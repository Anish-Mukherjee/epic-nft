...
contract MyEpicNFT is ERC721URIStorage {
    ...
    constructor() ERC721("ChocolateNFT", "CHOCOLATE") {
        console.log(
            "This is my NFT contract. Gonna reward myself with a chocolate once I'm done!"
        );
    }
            ...
            bytes(
                string(
                    abi.encodePacked(
                        '{"name": "',
                        combinedWord,
                        '", "description": "A highly acclaimed collection of unique chocolate names.", "image": "data:image/svg+xml;base64,',
